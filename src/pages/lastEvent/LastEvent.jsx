                        ...
                        <div className='grid grid-cols-2 lg:grid-cols-3 lg:gap-8 gap-4'>
                            {
                                upcommingevent?.map((items, idx) => (
                                    <EachEvents key={idx} events={items} btnStyle="py-1 px-3 rounded-md bg-primary md:bg-white md:border md:border-pink-500 md:text-pink-500 text-white sm:px-10 sm:text-xl md:px-16"></EachEvents>
                                ))
                            }
                        </div>
                    </div>
