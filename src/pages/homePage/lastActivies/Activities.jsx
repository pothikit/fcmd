                ...
                <div className='py-10 lg:py-20 sm:hidden lg:block'>
                    <div className='grid grid-cols-2 gap-5 items-center'>
                        <div className='grid grid-cols-2 gap-1 lg:gap-3'>
                            <div>
                                <img src={handPen} alt="Hand Pen" className='w-full mt-8' />
                            </div>
                            <div>
                                <img src={sky} alt="Sky" className='w-full mb-8' />
                            </div>
                        </div>
                        <div className='space-y-3 lg:space-y-6'>
                            <Pagetitle pageTitle="Unleashing" coloredTittle={["Global", <br key={1} className='hidden lg:block' />, " Potential"]}></Pagetitle>
