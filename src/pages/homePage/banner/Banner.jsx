            ...
            <div className="container mx-auto">
                <div className='grid lg:grid-cols-2 gap-5 items-center'>
                    <div className='space-y-7'>
                        <h1 className='text-3xl lg:text-5xl font-bold leading-relaxed'><span className='font-medium'>Building a Thriving <br className='hidden lg:block' />Community of </span><br className='hidden lg:block' />Independent Talents</h1>
