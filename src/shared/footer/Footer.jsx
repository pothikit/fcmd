    ...
    return (
        <section className='pt-20 bg-primary px-4 lg:px-0'>
            <div className="container mx-auto">
                <div className='flex text-white lg:gap-5 flex-col lg:flex-row gap-20 items-start justify-center'>
                    <div className="lg:w-5/12 w-full space-y-12">
                        ...
                        <ul className='flex gap-5'>
                            <li><Link><FaFacebook size={24} /></Link></li>
                            <li><Link><FaInstagram size={24} /></Link></li>
                            <li><Link><BsTwitterX size={24} /></Link></li>
                            <li><Link><FaLinkedin size={24} /></Link></li>
                            <li><Link><FaLinkedin size={24} /></Link></li>
                        </ul>
                    </div>
                    <div className='lg:w-7/12 w-full flex justify-between flex-col md:flex-row gap-10'>
                        <div className='flex w-full md:justify-evenly'>
                            <div className='w-1/2 md:w-auto'>
                                <h2 className='text-sm font-bold mb-5'>Helpful Link</h2>
                            ...
                            <div className='w-1/2 md:w-auto'>
                                <h2 className='text-sm font-bold mb-5'>Blog</h2>
                                <ul className='space-y-3'>
                                ...
                                <div className='flex items-center gap-3 mt-5 flex-wrap lg:flex-nowrap'>
                                    {
                                        contributors?.slice(0, 4).map((contributor, idx) => (
                                            <Link key={idx} to={contributor?.website_url} className='p-1 bg-white rounded-md'>
                ...
                <div className="footer-bottom border-t-2 py-10 mt-20 flex justify-between flex-col md:flex-row gap-5">
